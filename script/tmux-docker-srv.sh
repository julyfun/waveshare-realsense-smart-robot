...
# [track person]
# tmux new-windo -t my
# tmux send-keys -t my:1 "cd" C-m
# tmux send-keys -t my:1 "python3 -m ws.ttf_server" C-m

# tmux split-win -v -t my:1
# tmux send-keys -t my:1.1 "cd ~/ws" C-m
# tmux send-keys -t my:1.1 "python3 track_person.py" C-m

# [catch obj]
tmux split-win -v -t my:1
tmux send-keys -t my:1.2 "cd ~/ws" C-m
tmux send-keys -t my:1.2 "python3 catch5.py" C-m
tmux send-keys -t my:1.2 "echo 1234321 | sudo -S chmod 666 /dev/ttyUSB*" C-m
tmux send-keys -t my:1.2 "ros2 run roarm_driver roarm_driver" C-m

# [end]
tmux select-layout -t my:0 tiled
tmux select-layout -t my:1 tiled
