...
class ObjectTracker:
    ...
    def wait_for_track_one_xyz(self, labels: List[str], area_limit: float, want_img=False) -> Optional[Tuple[np.ndarray, np.ndarray, Optional[np.ndarray]]]:
        ...
        if len(obj_masks):
            ...
            if want_img:
                ...
                return so_obs, so_xyz, images

            return so_obs, so_xyz, None
        return None
